...
-- I wasn't sure what the "most specific possible types" part meant. Obviously the type variables could be replaced with specific types, but then there would be other combinations of types that wouldn't be included.
